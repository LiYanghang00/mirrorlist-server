...
do
    ...
    ./mirrorlist-server --listen 0.0.0.0 -c ./config1/mirrorlist_cache.proto -g ./config/global_netblocks.txt --log ./log/mirrorlist-server.log --cccsv ./config/country_continent.csv --geoip ./config/GeoLite2-Country.mmdb &
